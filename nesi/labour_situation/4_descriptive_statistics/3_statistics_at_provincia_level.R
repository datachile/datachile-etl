...
write.csv(weighted_mean_sex_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_provincia.csv")
write.csv(weighted_mean_sex_icse_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_icse_provincia.csv")
write.csv(weighted_mean_sex_isced_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isced_provincia.csv")
write.csv(weighted_mean_sex_isco_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isco_provincia.csv")
write.csv(weighted_mean_sex_isic_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isic_provincia.csv")
write.csv(weighted_mean_sex_work_day_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_work_day_provincia.csv")
write.csv(weighted_mean_sex_company_size_provincia, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_company_size_provincia.csv")

write.csv(weighted_median_sex_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_provincia.csv")
write.csv(weighted_median_sex_icse_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_icse_provincia.csv")
write.csv(weighted_median_sex_isced_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isced_provincia.csv")
write.csv(weighted_median_sex_isco_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isco_provincia.csv")
write.csv(weighted_median_sex_isic_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isic_provincia.csv")
write.csv(weighted_median_sex_work_day_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_work_day_provincia.csv")
write.csv(weighted_median_sex_company_size_provincia, file = "labour_situation/csv_intermediate_files/weighted_median_sex_company_size_provincia.csv")

write.csv(lb_weighted_median_sex_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_provincia.csv")
write.csv(lb_weighted_median_sex_icse_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_icse_provincia.csv")
write.csv(lb_weighted_median_sex_isced_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isced_provincia.csv")
write.csv(lb_weighted_median_sex_isco_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isco_provincia.csv")
write.csv(lb_weighted_median_sex_isic_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isic_provincia.csv")
write.csv(lb_weighted_median_sex_work_day_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_work_day_provincia.csv")
write.csv(lb_weighted_median_sex_company_size_provincia, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_company_size_provincia.csv")

write.csv(ub_weighted_median_sex_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_provincia.csv")
write.csv(ub_weighted_median_sex_icse_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_icse_provincia.csv")
write.csv(ub_weighted_median_sex_isced_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isced_provincia.csv")
write.csv(ub_weighted_median_sex_isco_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isco_provincia.csv")
write.csv(ub_weighted_median_sex_isic_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isic_provincia.csv")
write.csv(ub_weighted_median_sex_work_day_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_work_day_provincia.csv")
write.csv(ub_weighted_median_sex_company_size_provincia, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_company_size_provincia.csv")

write.csv(sex_provincia, file = "labour_situation/csv_intermediate_files/sex_provincia.csv")
write.csv(sex_icse_provincia, file = "labour_situation/csv_intermediate_files/sex_icse_provincia.csv")
write.csv(sex_isced_provincia, file = "labour_situation/csv_intermediate_files/sex_isced_provincia.csv")
write.csv(sex_isco_provincia, file = "labour_situation/csv_intermediate_files/sex_isco_provincia.csv")
write.csv(sex_isic_provincia, file = "labour_situation/csv_intermediate_files/sex_isic_provincia.csv")
write.csv(sex_work_day_provincia, file = "labour_situation/csv_intermediate_files/sex_work_day_provincia.csv")
write.csv(sex_company_size_provincia, file = "labour_situation/csv_intermediate_files/sex_company_size_provincia.csv")

save(sex_provincia, file = "labour_situation/rdata_intermediate_files/sex_provincia.RData")
save(sex_icse_provincia, file = "labour_situation/rdata_intermediate_files/sex_icse_provincia.RData")
save(sex_isced_provincia, file = "labour_situation/rdata_intermediate_files/sex_isced_provincia.RData")
save(sex_isco_provincia, file = "labour_situation/rdata_intermediate_files/sex_isco_provincia.RData")
save(sex_isic_provincia, file = "labour_situation/rdata_intermediate_files/sex_isic_provincia.RData")
save(sex_work_day_provincia, file = "labour_situation/rdata_intermediate_files/sex_work_day_provincia.RData")
save(sex_company_size_provincia, file = "labour_situation/rdata_intermediate_files/sex_company_size_provincia.RData")
