...
write.csv(weighted_mean_sex_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_region.csv")
write.csv(weighted_mean_sex_icse_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_icse_region.csv")
write.csv(weighted_mean_sex_isced_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isced_region.csv")
write.csv(weighted_mean_sex_isco_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isco_region.csv")
write.csv(weighted_mean_sex_isic_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isic_region.csv")
write.csv(weighted_mean_sex_work_day_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_work_day_region.csv")
write.csv(weighted_mean_sex_company_size_region, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_company_size_region.csv")

write.csv(weighted_median_sex_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_region.csv")
write.csv(weighted_median_sex_icse_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_icse_region.csv")
write.csv(weighted_median_sex_isced_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isced_region.csv")
write.csv(weighted_median_sex_isco_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isco_region.csv")
write.csv(weighted_median_sex_isic_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isic_region.csv")
write.csv(weighted_median_sex_work_day_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_work_day_region.csv")
write.csv(weighted_median_sex_company_size_region, file = "labour_situation/csv_intermediate_files/weighted_median_sex_company_size_region.csv")

write.csv(lb_weighted_median_sex_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_region.csv")
write.csv(lb_weighted_median_sex_icse_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_icse_region.csv")
write.csv(lb_weighted_median_sex_isced_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isced_region.csv")
write.csv(lb_weighted_median_sex_isco_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isco_region.csv")
write.csv(lb_weighted_median_sex_isic_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isic_region.csv")
write.csv(lb_weighted_median_sex_work_day_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_work_day_region.csv")
write.csv(lb_weighted_median_sex_company_size_region, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_company_size_region.csv")

write.csv(ub_weighted_median_sex_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_region.csv")
write.csv(ub_weighted_median_sex_icse_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_icse_region.csv")
write.csv(ub_weighted_median_sex_isced_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isced_region.csv")
write.csv(ub_weighted_median_sex_isco_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isco_region.csv")
write.csv(ub_weighted_median_sex_isic_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isic_region.csv")
write.csv(ub_weighted_median_sex_work_day_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_work_day_region.csv")
write.csv(ub_weighted_median_sex_company_size_region, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_company_size_region.csv")

write.csv(sex_region, file = "labour_situation/csv_intermediate_files/sex_region.csv")
write.csv(sex_icse_region, file = "labour_situation/csv_intermediate_files/sex_icse_region.csv")
write.csv(sex_isced_region, file = "labour_situation/csv_intermediate_files/sex_isced_region.csv")
write.csv(sex_isco_region, file = "labour_situation/csv_intermediate_files/sex_isco_region.csv")
write.csv(sex_isic_region, file = "labour_situation/csv_intermediate_files/sex_isic_region.csv")
write.csv(sex_work_day_region, file = "labour_situation/csv_intermediate_files/sex_work_day_region.csv")
write.csv(sex_company_size_region, file = "labour_situation/csv_intermediate_files/sex_company_size_region.csv")

save(sex_region, file = "labour_situation/rdata_intermediate_files/sex_region.RData")
save(sex_icse_region, file = "labour_situation/rdata_intermediate_files/sex_icse_region.RData")
save(sex_isced_region, file = "labour_situation/rdata_intermediate_files/sex_isced_region.RData")
save(sex_isco_region, file = "labour_situation/rdata_intermediate_files/sex_isco_region.RData")
save(sex_isic_region, file = "labour_situation/rdata_intermediate_files/sex_isic_region.RData")
save(sex_work_day_region, file = "labour_situation/rdata_intermediate_files/sex_work_day_region.RData")
save(sex_company_size_region, file = "labour_situation/rdata_intermediate_files/sex_company_size_region.RData")
