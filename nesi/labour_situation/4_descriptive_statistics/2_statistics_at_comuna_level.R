...
write.csv(sex_comuna, file = "labour_situation/csv_intermediate_files/sex_comuna.csv")
write.csv(sex_icse_comuna, file = "labour_situation/csv_intermediate_files/sex_icse_comuna.csv")
write.csv(sex_isced_comuna, file = "labour_situation/csv_intermediate_files/sex_isced_comuna.csv")
write.csv(sex_isco_comuna, file = "labour_situation/csv_intermediate_files/sex_isco_comuna.csv")
write.csv(sex_isic_comuna, file = "labour_situation/csv_intermediate_files/sex_isic_comuna.csv")
write.csv(sex_work_day_comuna, file = "labour_situation/csv_intermediate_files/sex_work_day_comuna.csv")
write.csv(sex_company_size_comuna, file = "labour_situation/csv_intermediate_files/sex_company_size_comuna.csv")
