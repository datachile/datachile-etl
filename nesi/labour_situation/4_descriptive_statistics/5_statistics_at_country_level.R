...
write.csv(weighted_mean_sex_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_country.csv")
write.csv(weighted_mean_sex_icse_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_icse_country.csv")
write.csv(weighted_mean_sex_isced_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isced_country.csv")
write.csv(weighted_mean_sex_isco_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isco_country.csv")
write.csv(weighted_mean_sex_isic_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_isic_country.csv")
write.csv(weighted_mean_sex_work_day_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_work_day_country.csv")
write.csv(weighted_mean_sex_company_size_country, file = "labour_situation/csv_intermediate_files/weighted_mean_sex_company_size_country.csv")

write.csv(weighted_median_sex_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_country.csv")
write.csv(weighted_median_sex_icse_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_icse_country.csv")
write.csv(weighted_median_sex_isced_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isced_country.csv")
write.csv(weighted_median_sex_isco_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isco_country.csv")
write.csv(weighted_median_sex_isic_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_isic_country.csv")
write.csv(weighted_median_sex_work_day_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_work_day_country.csv")
write.csv(weighted_median_sex_company_size_country, file = "labour_situation/csv_intermediate_files/weighted_median_sex_company_size_country.csv")

write.csv(lb_weighted_median_sex_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_country.csv")
write.csv(lb_weighted_median_sex_icse_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_icse_country.csv")
write.csv(lb_weighted_median_sex_isced_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isced_country.csv")
write.csv(lb_weighted_median_sex_isco_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isco_country.csv")
write.csv(lb_weighted_median_sex_isic_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_isic_country.csv")
write.csv(lb_weighted_median_sex_work_day_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_work_day_country.csv")
write.csv(lb_weighted_median_sex_company_size_country, file = "labour_situation/csv_intermediate_files/lb_weighted_median_sex_company_size_country.csv")

write.csv(ub_weighted_median_sex_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_country.csv")
write.csv(ub_weighted_median_sex_icse_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_icse_country.csv")
write.csv(ub_weighted_median_sex_isced_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isced_country.csv")
write.csv(ub_weighted_median_sex_isco_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isco_country.csv")
write.csv(ub_weighted_median_sex_isic_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_isic_country.csv")
write.csv(ub_weighted_median_sex_work_day_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_work_day_country.csv")
write.csv(ub_weighted_median_sex_company_size_country, file = "labour_situation/csv_intermediate_files/ub_weighted_median_sex_company_size_country.csv")

write.csv(sex_country, file = "labour_situation/csv_intermediate_files/sex_country.csv")
write.csv(sex_icse_country, file = "labour_situation/csv_intermediate_files/sex_icse_country.csv")
write.csv(sex_isced_country, file = "labour_situation/csv_intermediate_files/sex_isced_country.csv")
write.csv(sex_isco_country, file = "labour_situation/csv_intermediate_files/sex_isco_country.csv")
write.csv(sex_isic_country, file = "labour_situation/csv_intermediate_files/sex_isic_country.csv")
write.csv(sex_work_day_country, file = "labour_situation/csv_intermediate_files/sex_work_day_country.csv")
write.csv(sex_company_size_country, file = "labour_situation/csv_intermediate_files/sex_company_size_country.csv")

save(sex_country, file = "labour_situation/rdata_intermediate_files/sex_country.RData")
save(sex_icse_country, file = "labour_situation/rdata_intermediate_files/sex_icse_country.RData")
save(sex_isced_country, file = "labour_situation/rdata_intermediate_files/sex_isced_country.RData")
save(sex_isco_country, file = "labour_situation/rdata_intermediate_files/sex_isco_country.RData")
save(sex_isic_country, file = "labour_situation/rdata_intermediate_files/sex_isic_country.RData")
save(sex_work_day_country, file = "labour_situation/rdata_intermediate_files/sex_work_day_country.RData")
save(sex_company_size_country, file = "labour_situation/rdata_intermediate_files/sex_company_size_country.RData")
