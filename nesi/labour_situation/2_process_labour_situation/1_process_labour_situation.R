...
save(nesi_individuals_with_grants_2010, file = "labour_situation/3_processed_labour_situation/labour_situation_2010.RData")
save(nesi_individuals_with_grants_2011, file = "labour_situation/3_processed_labour_situation/labour_situation_2011.RData")
save(nesi_individuals_with_grants_2012, file = "labour_situation/3_processed_labour_situation/labour_situation_2012.RData")
save(nesi_individuals_with_grants_2013, file = "labour_situation/3_processed_labour_situation/labour_situation_2013.RData")
save(nesi_individuals_with_grants_2014, file = "labour_situation/3_processed_labour_situation/labour_situation_2014.RData")
save(nesi_individuals_with_grants_2015, file = "labour_situation/3_processed_labour_situation/labour_situation_2015.RData")
