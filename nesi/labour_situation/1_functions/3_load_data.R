...
households_with_grants_load_dataset <- function(year){
  ...
  RData <- paste0("nesi_", year, "/households/nesi_households_with_grants_", year, ".RData")
...
## Households without grants (years 2010, 2013, 2014 & 2015 don't have files without grants columns)

households_without_grants_load_dataset <- function(year){
  url <- paste0("https://users.dcc.uchile.cl/~mvargas/nesi/nesi_", year, "/households/nesi_households_without_grants_", year, "_R.zip")
  folder <- paste0("nesi_", year)
  subfolder <- paste0("nesi_", year,"/households")
  zip <- paste0("nesi_", year, "/households/nesi_households_without_grants_", year, "_R.zip")
  RData <- paste0("nesi_", year, "/households/nesi_households_without_grants_", year, ".RData")
