...
source("household_statistics_comuna/household_statistics_comuna.R")
...
write.csv(median_income_comuna, file = "csv_intermediate_files/median_income_comuna.csv")
write.csv(mean_income_comuna, file = "csv_intermediate_files/mean_income_comuna.csv")
write.csv(gini_income_comuna, file = "csv_intermediate_files/gini_income_comuna.csv")
write.csv(tidy_all_comuna, file = "csv_final_files/tidy_all_comuna.csv")
