source("wage_by_gender_and_occupation_with_weights/wage_by_gender_and_occupation_with_weights_statistics_region/wage_by_gender_and_occupation_with_weights_statistics_region.R")
...
tidy_all_region <- join(tidy_weighted_mean_income_region, tidy_weighted_median_income_region, by = c("region","sex","occupation","year"))
tidy_all_region <- join(tidy_all_region, tidy_lb_weighted_mean_income_region, by = c("region","sex","occupation","year"))
tidy_all_region <- join(tidy_all_region, tidy_ub_weighted_mean_income_region, by = c("region","sex","occupation","year"))
tidy_all_region <- join(tidy_all_region, tidy_lb_weighted_median_income_region, by = c("region","sex","occupation","year"))
tidy_all_region <- join(tidy_all_region, tidy_ub_weighted_median_income_region, by = c("region","sex","occupation","year"))
...
write.csv(weighted_median_income_region, file = "wage_by_gender_and_occupation_with_weights/csv_intermediate_files/wage_by_gender_and_occupation_with_weights_weighted_median_income_region.csv")
write.csv(weighted_mean_income_region, file = "wage_by_gender_and_occupation_with_weights/csv_intermediate_files/wage_by_gender_and_occupation_with_weights_weighted_mean_income_region.csv")
write.csv(tidy_all_region, file = "wage_by_gender_and_occupation_with_weights/csv_final_files/wage_by_gender_and_occupation_with_weights_tidy_all_region.csv")
