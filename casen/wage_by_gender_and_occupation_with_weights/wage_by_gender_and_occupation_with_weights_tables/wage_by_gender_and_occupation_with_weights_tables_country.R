source("wage_by_gender_and_occupation_with_weights/wage_by_gender_and_occupation_with_weights_statistics_country/wage_by_gender_and_occupation_with_weights_statistics_country.R")

###############
# join median #
###############

occupation <- unique(c(as.character(weighted_median_2015_country$occupation),
                       as.character(weighted_median_2013_country$occupation),
                       as.character(weighted_median_2011_country$occupation)))

weighted_median_income_country <- as.data.frame(occupation)
...
weighted_mean_income_country <- as.data.frame(occupation)
...
lb_weighted_median_income_country <- as.data.frame(occupation)
...
ub_weighted_median_income_country <- as.data.frame(occupation)
...
lb_weighted_mean_income_country <- as.data.frame(occupation)
...
ub_weighted_mean_income_country <- as.data.frame(occupation)
...
tidy_all_country <- join(tidy_weighted_mean_income_country, tidy_weighted_median_income_country, by = c("sex","occupation","year"))
tidy_all_country <- join(tidy_all_country, tidy_lb_weighted_mean_income_country, by = c("sex","occupation","year"))
tidy_all_country <- join(tidy_all_country, tidy_ub_weighted_mean_income_country, by = c("sex","occupation","year"))
tidy_all_country <- join(tidy_all_country, tidy_lb_weighted_median_income_country, by = c("sex","occupation","year"))
tidy_all_country <- join(tidy_all_country, tidy_ub_weighted_median_income_country, by = c("sex","occupation","year"))
...
write.csv(weighted_median_income_country, file = "wage_by_gender_and_occupation_with_weights/csv_intermediate_files/wage_by_gender_and_occupation_with_weights_weighted_median_income_country.csv")
write.csv(weighted_mean_income_country, file = "wage_by_gender_and_occupation_with_weights/csv_intermediate_files/wage_by_gender_and_occupation_with_weights_weighted_mean_income_country.csv")
write.csv(tidy_all_country, file = "wage_by_gender_and_occupation_with_weights/csv_final_files/wage_by_gender_and_occupation_with_weights_tidy_all_country.csv")
