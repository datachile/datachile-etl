source("wage_by_gender_and_branch_with_weights/wage_by_gender_and_branch_with_weights_statistics_provincia/wage_by_gender_and_branch_with_weights_statistics_provincia.R")
...
tidy_all_provincia <- join(tidy_weighted_mean_income_provincia, tidy_weighted_median_income_provincia, by = c("provincia","sex","branch","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_lb_weighted_mean_income_provincia, by = c("provincia","sex","branch","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_ub_weighted_mean_income_provincia, by = c("provincia","sex","branch","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_lb_weighted_median_income_provincia, by = c("provincia","sex","branch","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_ub_weighted_median_income_provincia, by = c("provincia","sex","branch","year"))
...
write.csv(weighted_median_income_provincia, file = "wage_by_gender_and_branch_with_weights/csv_intermediate_files/wage_by_gender_and_branch_with_weights_weighted_median_income_provincia.csv")
write.csv(weighted_mean_income_provincia, file = "wage_by_gender_and_branch_with_weights/csv_intermediate_files/wage_by_gender_and_branch_with_weights_weighted_mean_income_provincia.csv")
write.csv(tidy_all_provincia, file = "wage_by_gender_and_branch_with_weights/csv_final_files/wage_by_gender_and_branch_with_weights_tidy_all_provincia.csv")
