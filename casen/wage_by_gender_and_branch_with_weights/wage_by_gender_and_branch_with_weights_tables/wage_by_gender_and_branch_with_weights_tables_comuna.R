source("wage_by_gender_and_branch_with_weights/wage_by_gender_and_branch_with_weights_statistics_comuna/wage_by_gender_and_branch_with_weights_statistics_comuna.R")
...
tidy_all_comuna <- join(tidy_weighted_mean_income_comuna, tidy_weighted_median_income_comuna, by = c("comuna","sex","branch","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_lb_weighted_mean_income_comuna, by = c("comuna","sex","branch","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_ub_weighted_mean_income_comuna, by = c("comuna","sex","branch","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_lb_weighted_median_income_comuna, by = c("comuna","sex","branch","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_ub_weighted_median_income_comuna, by = c("comuna","sex","branch","year"))
...
write.csv(weighted_median_income_comuna, file = "wage_by_gender_and_branch_with_weights/csv_intermediate_files/wage_by_gender_and_branch_with_weights_weighted_median_income_comuna.csv")
write.csv(weighted_mean_income_comuna, file = "wage_by_gender_and_branch_with_weights/csv_intermediate_files/wage_by_gender_and_branch_with_weights_weighted_mean_income_comuna.csv")
write.csv(tidy_all_comuna, file = "wage_by_gender_and_branch_with_weights/csv_final_files/wage_by_gender_and_branch_with_weights_tidy_all_comuna.csv")
