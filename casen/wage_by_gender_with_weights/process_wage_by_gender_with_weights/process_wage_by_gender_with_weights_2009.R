...
wage_by_gender_2009 <- as.data.frame(cbind(as.character(casen_2009$comu), as.character(casen_2009$yopraj), as.character(casen_2009$sexo), as.character(casen_2009$expr), as.character(casen_2009$expc)))
setnames(wage_by_gender_2009, colnames(wage_by_gender_2009), c("comuna","ingreso_ocup_principal", "sexo", "exp_region", "exp_comuna"))
...
wage_by_gender_2009 <- wage_by_gender_2009[,c("region","provincia","comuna","ingreso_ocup_principal", "sexo", "exp_region", "exp_comuna")]
...
# Fix exp
wage_by_gender_2009$exp_comuna <- as.numeric(as.character(wage_by_gender_2009$exp_comuna))
wage_by_gender_2009$exp_region <- as.numeric(as.character(wage_by_gender_2009$exp_region))
