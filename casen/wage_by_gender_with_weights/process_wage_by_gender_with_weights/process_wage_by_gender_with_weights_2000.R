...
wage_by_gender_2000 <- as.data.frame(cbind(as.character(casen_2000$comu), as.character(casen_2000$yopraj), as.character(casen_2000$sexo), as.character(casen_2000$expr), as.character(casen_2000$expc)))
setnames(wage_by_gender_2000, colnames(wage_by_gender_2000), c("comuna","ingreso_ocup_principal", "sexo", "exp_region", "exp_comuna"))
...
wage_by_gender_2000 <- wage_by_gender_2000[,c("region","provincia","comuna","ingreso_ocup_principal", "sexo", "exp_region", "exp_comuna")]
...
# Fix exp
wage_by_gender_2000$exp_comuna <- as.numeric(as.character(wage_by_gender_2000$exp_comuna))
wage_by_gender_2000$exp_region <- as.numeric(as.character(wage_by_gender_2000$exp_region))
