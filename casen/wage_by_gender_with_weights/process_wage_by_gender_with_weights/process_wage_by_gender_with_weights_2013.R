...
wage_by_gender_2013 <- as.data.frame(cbind(as.character(casen_2013$comu), as.character(casen_2013$yoprcor), as.character(casen_2013$sexo), as.character(casen_2013$expr), as.character(casen_2013$expc)))
setnames(wage_by_gender_2013, colnames(wage_by_gender_2013), c("comuna","ingreso_ocup_principal", "sexo", "exp_region", "exp_comuna"))
...
wage_by_gender_2013 <- wage_by_gender_2013[,c("region","provincia","comuna","ingreso_ocup_principal", "sexo", "exp_region", "exp_comuna")]
...
# Fix exp
wage_by_gender_2013$exp_comuna <- as.numeric(as.character(wage_by_gender_2013$exp_comuna))
wage_by_gender_2013$exp_region <- as.numeric(as.character(wage_by_gender_2013$exp_region))
