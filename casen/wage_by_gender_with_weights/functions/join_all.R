if ((exists("tidy_all_comuna") & exists("tidy_all_provincia") & exists("tidy_all_region") & exists("tidy_all_country")) == TRUE) {
  ...
  write.csv(tidy_all, file = "wage_by_gender_with_weights/csv_final_files/wage_by_gender_with_weights_tidy_all.csv")
} else {
  tidy_all_comuna <- read.csv("wage_by_gender_with_weights/csv_final_files/wage_by_gender_with_weights_tidy_all_comuna.csv")
  tidy_all_provincia <- read.csv("wage_by_gender_with_weights/csv_final_files/wage_by_gender_with_weights_tidy_all_provincia.csv")
  tidy_all_region <- read.csv("wage_by_gender_with_weights/csv_final_files/wage_by_gender_with_weights_tidy_all_region.csv")
  tidy_all_country <- read.csv("wage_by_gender_with_weights/csv_final_files/wage_by_gender_with_weights_tidy_all_country.csv")
