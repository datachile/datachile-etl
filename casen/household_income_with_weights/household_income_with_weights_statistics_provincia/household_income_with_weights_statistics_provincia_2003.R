...
# Median by provincia
weighted_median_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = matrixStats::weightedMedian(per_capita_income, w = exp_region, na.rm = TRUE))
setnames(weighted_median_2003_provincia, colnames(weighted_median_2003_provincia), c("provincia","2003"))
#weighted_median_2003_provincia <- insert_row(weighted_median_2003_provincia, c("Pa\u00eds", median(household_income_with_weights_2003$per_capita_income, na.rm = TRUE)), nrow(weighted_median_2003_provincia)+1)
...
# Mean by provincia
weighted_mean_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = matrixStats::weightedMean(per_capita_income, w = exp_region, na.rm = TRUE))
...
# Gini by provincia
weighted_gini_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = SciencesPo::Gini(per_capita_income, weights = exp_region, na.rm = TRUE))
...
lb_weighted_median_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = lb_weighted_median_plyr(per_capita_income, exp_region))
...
ub_weighted_median_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = ub_weighted_median_plyr(per_capita_income, exp_region))
...
lb_weighted_mean_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = lb_weighted_mean_plyr(per_capita_income, exp_region))
...
ub_weighted_mean_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = ub_weighted_mean_plyr(per_capita_income, exp_region))
...
lb_weighted_gini_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = lb_weighted_gini_plyr(per_capita_income, exp_region))
...
ub_weighted_gini_2003_provincia <- ddply(household_income_with_weights_2003, .(provincia), summarise, FUN = ub_weighted_gini_plyr(per_capita_income, exp_region))
