...
lb_weighted_median_country <- c(lb_weighted_median(household_income_with_weights_1990),
                                lb_weighted_median(household_income_with_weights_1992),
                                lb_weighted_median(household_income_with_weights_1994),
                                lb_weighted_median(household_income_with_weights_1996),
                                lb_weighted_median(household_income_with_weights_1998),
                                lb_weighted_median(household_income_with_weights_2000),
                                lb_weighted_median(household_income_with_weights_2003),
                                lb_weighted_median(household_income_with_weights_2006),
                                lb_weighted_median(household_income_with_weights_2009),
                                lb_weighted_median(household_income_with_weights_2011),
                                lb_weighted_median(household_income_with_weights_2013),
                                lb_weighted_median(household_income_with_weights_2015))

ub_weighted_median_country <- c(ub_weighted_median(household_income_with_weights_1990),
                                ub_weighted_median(household_income_with_weights_1992),
                                ub_weighted_median(household_income_with_weights_1994),
                                ub_weighted_median(household_income_with_weights_1996),
                                ub_weighted_median(household_income_with_weights_1998),
                                ub_weighted_median(household_income_with_weights_2000),
                                ub_weighted_median(household_income_with_weights_2003),
                                ub_weighted_median(household_income_with_weights_2006),
                                ub_weighted_median(household_income_with_weights_2009),
                                ub_weighted_median(household_income_with_weights_2011),
                                ub_weighted_median(household_income_with_weights_2013),
                                ub_weighted_median(household_income_with_weights_2015))

########
# Mean #
########

lb_weighted_mean_country <- c(lb_weighted_mean(household_income_with_weights_1990),
                              lb_weighted_mean(household_income_with_weights_1992),
                              lb_weighted_mean(household_income_with_weights_1994),
                              lb_weighted_mean(household_income_with_weights_1996),
                              lb_weighted_mean(household_income_with_weights_1998),
                              lb_weighted_mean(household_income_with_weights_2000),
                              lb_weighted_mean(household_income_with_weights_2003),
                              lb_weighted_mean(household_income_with_weights_2006),
                              lb_weighted_mean(household_income_with_weights_2009),
                              lb_weighted_mean(household_income_with_weights_2011),
                              lb_weighted_mean(household_income_with_weights_2013),
                              lb_weighted_mean(household_income_with_weights_2015))

ub_weighted_mean_country <- c(ub_weighted_mean(household_income_with_weights_1990),
                              ub_weighted_mean(household_income_with_weights_1992),
                              ub_weighted_mean(household_income_with_weights_1994),
                              ub_weighted_mean(household_income_with_weights_1996),
                              ub_weighted_mean(household_income_with_weights_1998),
                              ub_weighted_mean(household_income_with_weights_2000),
                              ub_weighted_mean(household_income_with_weights_2003),
                              ub_weighted_mean(household_income_with_weights_2006),
                              ub_weighted_mean(household_income_with_weights_2009),
                              ub_weighted_mean(household_income_with_weights_2011),
                              ub_weighted_mean(household_income_with_weights_2013),
                              ub_weighted_mean(household_income_with_weights_2015))

########
# Gini #
########

lb_weighted_gini_country <- c(lb_weighted_gini(household_income_with_weights_1990),
                              lb_weighted_gini(household_income_with_weights_1992),
                              lb_weighted_gini(household_income_with_weights_1994),
                              lb_weighted_gini(household_income_with_weights_1996),
                              lb_weighted_gini(household_income_with_weights_1998),
                              lb_weighted_gini(household_income_with_weights_2000),
                              lb_weighted_gini(household_income_with_weights_2003),
                              lb_weighted_gini(household_income_with_weights_2006),
                              lb_weighted_gini(household_income_with_weights_2009),
                              lb_weighted_gini(household_income_with_weights_2011),
                              lb_weighted_gini(household_income_with_weights_2013),
                              lb_weighted_gini(household_income_with_weights_2015))

ub_weighted_gini_country <- c(ub_weighted_gini(household_income_with_weights_1990),
                              ub_weighted_gini(household_income_with_weights_1992),
                              ub_weighted_gini(household_income_with_weights_1994),
                              ub_weighted_gini(household_income_with_weights_1996),
                              ub_weighted_gini(household_income_with_weights_1998),
                              ub_weighted_gini(household_income_with_weights_2000),
                              ub_weighted_gini(household_income_with_weights_2003),
                              ub_weighted_gini(household_income_with_weights_2006),
                              ub_weighted_gini(household_income_with_weights_2009),
                              ub_weighted_gini(household_income_with_weights_2011),
                              ub_weighted_gini(household_income_with_weights_2013),
                              ub_weighted_gini(household_income_with_weights_2015))
