...
weighted_median_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = matrixStats::weightedMedian(ingreso_pc, w = exp_region, na.rm = TRUE))
weighted_median_1998_provincia$provincia <- as.character(weighted_median_1998_provincia$provincia)
setnames(weighted_median_1998_provincia, colnames(weighted_median_1998_provincia), c("provincia","1998"))
#weighted_median_1998_provincia <- insert_row(weighted_median_1998_provincia, c("Pa\u00eds", weighted_median(household_income_1998$ingreso_pc, na.rm = TRUE)), nrow(weighted_median_1998_provincia)+1)
...
weighted_mean_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = matrixStats::weightedMean(ingreso_pc, w = exp_region, na.rm = TRUE))
weighted_mean_1998_provincia$provincia <- as.character(weighted_mean_1998_provincia$provincia)
...
# Gini by provincia
weighted_gini_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = SciencesPo::Gini(ingreso_pc, weights = exp_region, na.rm = TRUE))
weighted_gini_1998_provincia$provincia <- as.character(weighted_gini_1998_provincia$provincia)
...
lb_weighted_median_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = lb_weighted_median_dplyr(ingreso_pc, exp_region))
lb_weighted_median_1998_provincia$provincia <- as.character(lb_weighted_median_1998_provincia$provincia)
...
ub_weighted_median_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = ub_weighted_median_dplyr(ingreso_pc, exp_region))
ub_weighted_median_1998_provincia$provincia <- as.character(ub_weighted_median_1998_provincia$provincia)
...
lb_weighted_mean_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = lb_weighted_mean_dplyr(ingreso_pc, exp_region))
lb_weighted_mean_1998_provincia$provincia <- as.character(lb_weighted_mean_1998_provincia$provincia)
...
ub_weighted_mean_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = ub_weighted_mean_dplyr(ingreso_pc, exp_region))
ub_weighted_mean_1998_provincia$provincia <- as.character(ub_weighted_mean_1998_provincia$provincia)
...
lb_weighted_gini_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = lb_weighted_gini_dplyr(ingreso_pc, exp_region))
lb_weighted_gini_1998_provincia$provincia <- as.character(lb_weighted_gini_1998_provincia$provincia)
...
ub_weighted_gini_1998_provincia <- ddply(household_income_1998, .(provincia), summarise, FUN = ub_weighted_gini_dplyr(ingreso_pc, exp_region))
ub_weighted_gini_1998_provincia$provincia <- as.character(ub_weighted_gini_1998_provincia$provincia)
