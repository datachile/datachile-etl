...
weighted_median_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = matrixStats::weightedMedian(ingreso_pc, w = exp_region, na.rm = TRUE))
weighted_median_1990_provincia$provincia <- as.character(weighted_median_1990_provincia$provincia)
setnames(weighted_median_1990_provincia, colnames(weighted_median_1990_provincia), c("provincia","1990"))
#weighted_median_1990_provincia <- insert_row(weighted_median_1990_provincia, c("Pa\u00eds", weighted_median(household_income_1990$ingreso_pc, na.rm = TRUE)), nrow(weighted_median_1990_provincia)+1)
...
weighted_mean_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = matrixStats::weightedMean(ingreso_pc, w = exp_region, na.rm = TRUE))
weighted_mean_1990_provincia$provincia <- as.character(weighted_mean_1990_provincia$provincia)
...
# Gini by provincia
weighted_gini_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = SciencesPo::Gini(ingreso_pc, weights = exp_region, na.rm = TRUE))
weighted_gini_1990_provincia$provincia <- as.character(weighted_gini_1990_provincia$provincia)
...
lb_weighted_median_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = lb_weighted_median_dplyr(ingreso_pc, exp_region))
lb_weighted_median_1990_provincia$provincia <- as.character(lb_weighted_median_1990_provincia$provincia)
...
ub_weighted_median_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = ub_weighted_median_dplyr(ingreso_pc, exp_region))
ub_weighted_median_1990_provincia$provincia <- as.character(ub_weighted_median_1990_provincia$provincia)
...
lb_weighted_mean_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = lb_weighted_mean_dplyr(ingreso_pc, exp_region))
lb_weighted_mean_1990_provincia$provincia <- as.character(lb_weighted_mean_1990_provincia$provincia)
...
ub_weighted_mean_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = ub_weighted_mean_dplyr(ingreso_pc, exp_region))
ub_weighted_mean_1990_provincia$provincia <- as.character(ub_weighted_mean_1990_provincia$provincia)
setnames(ub_weighted_mean_1990_provincia, colnames(ub_weighted_mean_1990_provincia), c("provincia","1990"))
...
lb_weighted_gini_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = lb_weighted_gini_dplyr(ingreso_pc, exp_region))
lb_weighted_gini_1990_provincia$provincia <- as.character(lb_weighted_gini_1990_provincia$provincia)
...
ub_weighted_gini_1990_provincia <- ddply(household_income_1990, .(provincia), summarise, FUN = ub_weighted_gini_dplyr(ingreso_pc, exp_region))
ub_weighted_gini_1990_provincia$provincia <- as.character(ub_weighted_gini_1990_provincia$provincia)
