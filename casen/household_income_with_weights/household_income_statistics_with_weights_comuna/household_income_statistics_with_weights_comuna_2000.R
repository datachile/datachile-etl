...
weighted_median_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = matrixStats::weightedMedian(ingreso_pc, w = exp_comuna, na.rm = TRUE))
weighted_median_2000_comuna$comuna <- as.character(weighted_median_2000_comuna$comuna)
setnames(weighted_median_2000_comuna, colnames(weighted_median_2000_comuna), c("comuna","2000"))
#weighted_median_2000_comuna <- insert_row(weighted_median_2000_comuna, c("Pa\u00eds", weighted_median(household_income_2000$ingreso_pc, na.rm = TRUE)), nrow(weighted_median_2000_comuna)+1)
...
weighted_mean_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = matrixStats::weightedMean(ingreso_pc, w = exp_comuna, na.rm = TRUE))
weighted_mean_2000_comuna$comuna <- as.character(weighted_mean_2000_comuna$comuna)
...
# Gini by comuna
weighted_gini_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = SciencesPo::Gini(ingreso_pc, weights = exp_comuna, na.rm = TRUE))
weighted_gini_2000_comuna$comuna <- as.character(weighted_gini_2000_comuna$comuna)
...
lb_weighted_median_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = lb_weighted_median_dplyr(ingreso_pc, exp_comuna))
lb_weighted_median_2000_comuna$comuna <- as.character(lb_weighted_median_2000_comuna$comuna)
...
ub_weighted_median_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = ub_weighted_median_dplyr(ingreso_pc, exp_comuna))
ub_weighted_median_2000_comuna$comuna <- as.character(ub_weighted_median_2000_comuna$comuna)
...
lb_weighted_mean_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = lb_weighted_mean_dplyr(ingreso_pc, exp_comuna))
lb_weighted_mean_2000_comuna$comuna <- as.character(lb_weighted_mean_2000_comuna$comuna)
...
ub_weighted_mean_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = ub_weighted_mean_dplyr(ingreso_pc, exp_comuna))
ub_weighted_mean_2000_comuna$comuna <- as.character(ub_weighted_mean_2000_comuna$comuna)
...
lb_weighted_gini_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = lb_weighted_gini_dplyr(ingreso_pc, exp_comuna))
lb_weighted_gini_2000_comuna$comuna <- as.character(lb_weighted_gini_2000_comuna$comuna)
...
ub_weighted_gini_2000_comuna <- ddply(household_income_2000, .(comuna), summarise, FUN = ub_weighted_gini_dplyr(ingreso_pc, exp_comuna))
ub_weighted_gini_2000_comuna$comuna <- as.character(ub_weighted_gini_2000_comuna$comuna)
