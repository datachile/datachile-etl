...
setnames(household_income_2000, colnames(household_income_2000), c("comuna","ingreso_pc", "exp_region", "exp_comuna"))
...
household_income_2000 <- household_income_2000[,c("comuna","provincia","region","ingreso_pc", "exp_region", "exp_comuna")]
...
household_income_2000$exp_region <- ifelse(household_income_2000$exp_region == 0, 1, household_income_2000$exp_region)
