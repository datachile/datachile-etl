...
setnames(household_income_1996, colnames(household_income_1996), c("comuna","ingreso_pc", "exp_region", "exp_comuna"))
...
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<e1>", "\u00e1", x))) # a with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<c1>", "\u00c1", x))) # A with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xe9", "\u00e9", x))) # e with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<e9>", "\u00e9", x))) # e with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xed", "\u00ed", x))) # i with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<ed>", "\u00ed", x))) # i with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xf3", "\u00f3", x))) # o with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<f3>", "\u00f3", x))) # o with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xfa", "\u00fa", x))) # u with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<fa>", "\u00fa", x))) # u with acute 
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xda", "\u00da", x))) # U with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<da>", "\u00da", x))) # U with acute
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xf1", "\u00f1", x))) # n with tilde
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<f1>", "\u00f1", x))) # n with tilde
...
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("\xd1", "\u00d1", x))) # N with tilde
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<d1>", "\u00d1", x))) # N with tilde
...
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub("<b4>", "\u0027", x))) # apostrophe
...
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub(" La ", " la ", x)))
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub(" Los ", " los ", x)))
household_income_1996 <- as.data.frame(lapply(household_income_1996, function(x) gsub(" Y ", " y ", x)))
...
household_income_1996 <- household_income_1996[,c("comuna","provincia","region","ingreso_pc", "exp_region", "exp_comuna")]
...
household_income_1996$exp_region <- ifelse(household_income_1996$exp_region == 0, 1, household_income_1996$exp_region)
