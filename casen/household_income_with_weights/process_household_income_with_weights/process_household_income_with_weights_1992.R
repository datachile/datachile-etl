...
setnames(household_income_1992, colnames(household_income_1992), c("comuna","ingreso_pc", "exp_region", "exp_comuna"))
...
household_income_1992 <- household_income_1992[,c("comuna","provincia","region","ingreso_pc", "exp_region", "exp_comuna")]
...
household_income_1992$exp_region <- ifelse(household_income_1992$exp_region == 0, 1, household_income_1992$exp_region)
