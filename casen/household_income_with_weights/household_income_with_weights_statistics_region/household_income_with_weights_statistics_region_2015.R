...
# Median by region
weighted_median_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = matrixStats::weightedMedian(per_capita_income, w = exp_region, na.rm = TRUE))
setnames(weighted_median_2015_region, colnames(weighted_median_2015_region), c("region","2015"))
#weighted_median_2015_region <- insert_row(weighted_median_2015_region, c("Pa\u00eds", median(household_income_with_weights_2015$per_capita_income, na.rm = TRUE)), nrow(weighted_median_2015_region)+1)
...
# Mean by region
weighted_mean_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = matrixStats::weightedMean(per_capita_income, w = exp_region, na.rm = TRUE))
...
# Gini by region
weighted_gini_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = SciencesPo::Gini(per_capita_income, weights = exp_region, na.rm = TRUE))
...
lb_weighted_median_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = lb_weighted_median_plyr(per_capita_income, exp_region))
...
ub_weighted_median_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = ub_weighted_median_plyr(per_capita_income, exp_region))
...
lb_weighted_mean_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = lb_weighted_mean_plyr(per_capita_income, exp_region))
...
ub_weighted_gini_2015_region <- ddply(household_income_with_weights_2015, .(region), summarise, FUN = ub_weighted_gini_plyr(per_capita_income, exp_region))
