...
weighted_median_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = matrixStats::weightedMedian(ingreso_pc, w = exp_region, na.rm = TRUE))
weighted_median_1994_region$region <- as.character(weighted_median_1994_region$region)
setnames(weighted_median_1994_region, colnames(weighted_median_1994_region), c("region","1994"))
#weighted_median_1994_region <- insert_row(weighted_median_1994_region, c("Pa\u00eds", weighted_median(household_income_1994$ingreso_pc, na.rm = TRUE)), nrow(weighted_median_1994_region)+1)
...
weighted_mean_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = matrixStats::weightedMean(ingreso_pc, w = exp_region, na.rm = TRUE))
weighted_mean_1994_region$region <- as.character(weighted_mean_1994_region$region)
...
# Gini by region
weighted_gini_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = SciencesPo::Gini(ingreso_pc, weights = exp_region, na.rm = TRUE))
weighted_gini_1994_region$region <- as.character(weighted_gini_1994_region$region)
...
lb_weighted_median_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = lb_weighted_median_dplyr(ingreso_pc, exp_region))
lb_weighted_median_1994_region$region <- as.character(lb_weighted_median_1994_region$region)
...
ub_weighted_median_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = ub_weighted_median_dplyr(ingreso_pc, exp_region))
ub_weighted_median_1994_region$region <- as.character(ub_weighted_median_1994_region$region)
...
lb_weighted_mean_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = lb_weighted_mean_dplyr(ingreso_pc, exp_region))
lb_weighted_mean_1994_region$region <- as.character(lb_weighted_mean_1994_region$region)
...
ub_weighted_mean_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = ub_weighted_mean_dplyr(ingreso_pc, exp_region))
ub_weighted_mean_1994_region$region <- as.character(ub_weighted_mean_1994_region$region)
...
lb_weighted_gini_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = lb_weighted_gini_dplyr(ingreso_pc, exp_region))
lb_weighted_gini_1994_region$region <- as.character(lb_weighted_gini_1994_region$region)
...
ub_weighted_gini_1994_region <- ddply(household_income_1994, .(region), summarise, FUN = ub_weighted_gini_dplyr(ingreso_pc, exp_region))
ub_weighted_gini_1994_region$region <- as.character(ub_weighted_gini_1994_region$region)
