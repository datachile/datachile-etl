source("household_income_with_weights/household_income_with_weights_statistics_comuna/household_income_with_weights_statistics_comuna.R")
...
write.csv(weighted_median_income_comuna, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_weighted_median_income_comuna.csv")
write.csv(weighted_mean_income_comuna, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_weighted_mean_income_comuna.csv")
