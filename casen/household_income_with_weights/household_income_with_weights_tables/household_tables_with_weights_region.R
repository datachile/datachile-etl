...
source("household_income_with_weights/household_income_statistics_with_weights_region/household_income_statistics_with_weights_region.R")

########################
# join weighted_median #
########################

weighted_median_income_region <- as.data.frame(unique(c(weighted_median_1990_region$region, weighted_median_2015_region$region)))
setnames(weighted_median_income_region, colnames(weighted_median_income_region), "region")
...
weighted_median_income_region <- weighted_median_income_region[order(weighted_median_income_region$region),]
rownames(weighted_median_income_region) <- c(seq(1:nrow(weighted_median_income_region)))

######################
# join weighted_mean #
######################

weighted_mean_income_region <- as.data.frame(unique(c(weighted_mean_1990_region$region, weighted_mean_2015_region$region)))
setnames(weighted_mean_income_region, colnames(weighted_mean_income_region), "region")
...
weighted_mean_income_region <- weighted_mean_income_region[order(weighted_mean_income_region$region),]
rownames(weighted_mean_income_region) <- c(seq(1:nrow(weighted_mean_income_region)))

######################
# join weighted_gini #
######################

weighted_gini_income_region <- as.data.frame(unique(c(weighted_gini_1990_region$region, weighted_gini_2015_region$region)))
setnames(weighted_gini_income_region, colnames(weighted_gini_income_region), "region")
...
weighted_gini_income_region <- weighted_gini_income_region[order(weighted_gini_income_region$region),]
rownames(weighted_gini_income_region) <- c(seq(1:nrow(weighted_gini_income_region)))

##################################
# join lb_weighted_median_income #
##################################

lb_weighted_median_income_region <- as.data.frame(unique(c(lb_weighted_median_1990_region$region, lb_weighted_median_2015_region$region)))
setnames(lb_weighted_median_income_region, colnames(lb_weighted_median_income_region), "region")
...
lb_weighted_median_income_region <- lb_weighted_median_income_region[order(lb_weighted_median_income_region$region),]
rownames(lb_weighted_median_income_region) <- c(seq(1:nrow(lb_weighted_median_income_region)))

##################################
# join ub_weighted_median_income #
##################################

ub_weighted_median_income_region <- as.data.frame(unique(c(ub_weighted_median_1990_region$region, ub_weighted_median_2015_region$region)))
setnames(ub_weighted_median_income_region, colnames(ub_weighted_median_income_region), "region")
...
ub_weighted_median_income_region <- ub_weighted_median_income_region[order(ub_weighted_median_income_region$region),]
rownames(ub_weighted_median_income_region) <- c(seq(1:nrow(ub_weighted_median_income_region)))

################################
# join lb_weighted_mean_income #
################################

lb_weighted_mean_income_region <- as.data.frame(unique(c(lb_weighted_mean_1990_region$region, lb_weighted_mean_2015_region$region)))
setnames(lb_weighted_mean_income_region, colnames(lb_weighted_mean_income_region), "region")
...
lb_weighted_mean_income_region <- lb_weighted_mean_income_region[order(lb_weighted_mean_income_region$region),]
rownames(lb_weighted_mean_income_region) <- c(seq(1:nrow(lb_weighted_mean_income_region)))

################################
# join ub_weighted_mean_income #
################################

ub_weighted_mean_income_region <- as.data.frame(unique(c(ub_weighted_mean_1990_region$region, ub_weighted_mean_2015_region$region)))
setnames(ub_weighted_mean_income_region, colnames(ub_weighted_mean_income_region), "region")
...
ub_weighted_mean_income_region <- ub_weighted_mean_income_region[order(ub_weighted_mean_income_region$region),]
rownames(ub_weighted_mean_income_region) <- c(seq(1:nrow(ub_weighted_mean_income_region)))

################################
# join lb_weighted_gini_income #
################################

lb_weighted_gini_income_region <- as.data.frame(unique(c(lb_weighted_gini_1990_region$region, lb_weighted_gini_2015_region$region)))
setnames(lb_weighted_gini_income_region, colnames(lb_weighted_gini_income_region), "region")
...
lb_weighted_gini_income_region <- lb_weighted_gini_income_region[order(lb_weighted_gini_income_region$region),]
rownames(lb_weighted_gini_income_region) <- c(seq(1:nrow(lb_weighted_gini_income_region)))

################################
# join ub_weighted_gini_income #
################################

ub_weighted_gini_income_region <- as.data.frame(unique(c(ub_weighted_gini_1990_region$region, ub_weighted_gini_2015_region$region)))
setnames(ub_weighted_gini_income_region, colnames(ub_weighted_gini_income_region), "region")
...
ub_weighted_gini_income_region <- ub_weighted_gini_income_region[order(ub_weighted_gini_income_region$region),]
rownames(ub_weighted_gini_income_region) <- c(seq(1:nrow(ub_weighted_gini_income_region)))
...
write.csv(weighted_median_income_region, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_median_income_region.csv")
write.csv(weighted_mean_income_region, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_mean_income_region.csv")
write.csv(weighted_gini_income_region, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_gini_income_region.csv")
write.csv(tidy_all_region, file = "household_income_with_weights/csv_final_files/household_income_with_weights_tidy_all_region.csv")

##################
# free up memory #
##################

rm(weighted_median_income_region, weighted_mean_income_region, weighted_gini_income_region,
   lb_weighted_median_income_region, lb_weighted_mean_income_region, lb_weighted_gini_income_region,
   ub_weighted_median_income_region, ub_weighted_mean_income_region, ub_weighted_gini_income_region)

rm(tidy_weighted_median_income_region, tidy_weighted_mean_income_region, tidy_weighted_gini_income_region,
   tidy_lb_weighted_median_income_region, tidy_lb_weighted_mean_income_region, tidy_lb_weighted_gini_income_region,
   tidy_ub_weighted_median_income_region, tidy_ub_weighted_mean_income_region, tidy_ub_weighted_gini_income_region)
