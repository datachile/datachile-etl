source("household_income_with_weights/household_income_with_weights_statistics_region/household_income_with_weights_statistics_region.R")
...
write.csv(weighted_median_income_region, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_weighted_median_income_region.csv")
write.csv(weighted_mean_income_region, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_weighted_mean_income_region.csv")
