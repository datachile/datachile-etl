source("household_income_with_weights/household_income_with_weights_statistics_provincia/household_income_with_weights_statistics_provincia.R")
...
write.csv(weighted_median_income_provincia, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_weighted_median_income_provincia.csv")
write.csv(weighted_mean_income_provincia, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_weighted_mean_income_provincia.csv")
