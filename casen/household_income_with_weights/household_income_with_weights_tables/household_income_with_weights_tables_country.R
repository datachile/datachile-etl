source("household_income_with_weights/household_income_with_weights_statistics_country/household_income_with_weights_statistics_country.R")
...
write.csv(weighted_median_income_country, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_median_income_country.csv")
write.csv(weighted_mean_income_country, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_mean_income_country.csv")
write.csv(weighted_gini_income_country, file = "household_income_with_weights/csv_intermediate_files/household_income_with_weights_gini_income_country.csv")
write.csv(tidy_all_country, file = "household_income_with_weights/csv_final_files/household_income_with_weights_tidy_all_country.csv")
