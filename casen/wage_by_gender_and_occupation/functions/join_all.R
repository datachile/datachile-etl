if ((exists("tidy_all_comuna") & exists("tidy_all_provincia") & exists("tidy_all_region")) == TRUE) {
  ...
  tidy_all_comuna <- read.csv("wage_by_gender_and_occupation/csv_final_files/wage_by_gender_and_occupationtidy_all_comuna.csv")
  tidy_all_provincia <- read.csv("wage_by_gender_and_occupation/csv_final_files/wage_by_gender_and_occupationtidy_all_provincia.csv")
  tidy_all_region <- read.csv("wage_by_gender_and_occupation/csv_final_files/wage_by_gender_and_occupationtidy_all_region.csv")
