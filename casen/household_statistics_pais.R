...
median_vector_pais <- c(median(household_income_1990$ingreso_pc),
...
mean_vector_pais <- c(mean(household_income_1990$ingreso_pc),
                      ...
                      mean(household_income_2015$ingreso_pc))

########
# Gini #
########

gini_vector_pais <- c(Gini(household_income_1990$ingreso_pc),
