...
median_1990_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1990, FUN = median, na.rm = TRUE)
setnames(median_1990_region, colnames(median_1990_region), c("sexo","region","1990"))
...
mean_1990_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1990, FUN = mean, na.rm = TRUE)
setnames(mean_1990_region, colnames(mean_1990_region), c("sexo","region","1990"))
...
lb_median_1990_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1990, FUN = lb_median)
setnames(lb_median_1990_region, colnames(lb_median_1990_region), c("sexo","region","1990"))
...
ub_median_1990_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1990, FUN = ub_median)
setnames(ub_median_1990_region, colnames(ub_median_1990_region), c("sexo","region","1990"))
...
lb_mean_1990_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1990, FUN = lb_mean)
setnames(lb_mean_1990_region, colnames(lb_mean_1990_region), c("sexo","region","1990"))
...
ub_mean_1990_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1990, FUN = ub_mean)
setnames(ub_mean_1990_region, colnames(ub_mean_1990_region), c("sexo","region","1990"))
