...
median_2011_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2011, FUN = median, na.rm = TRUE)
setnames(median_2011_region, colnames(median_2011_region), c("sexo","region","2011"))
...
mean_2011_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2011, FUN = mean, na.rm = TRUE)
setnames(mean_2011_region, colnames(mean_2011_region), c("sexo","region","2011"))
...
lb_median_2011_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2011, FUN = lb_median)
setnames(lb_median_2011_region, colnames(lb_median_2011_region), c("sexo","region","2011"))
...
ub_median_2011_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2011, FUN = ub_median)
setnames(ub_median_2011_region, colnames(ub_median_2011_region), c("sexo","region","2011"))
...
lb_mean_2011_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2011, FUN = lb_mean)
setnames(lb_mean_2011_region, colnames(lb_mean_2011_region), c("sexo","region","2011"))
...
ub_mean_2011_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2011, FUN = ub_mean)
setnames(ub_mean_2011_region, colnames(ub_mean_2011_region), c("sexo","region","2011"))
