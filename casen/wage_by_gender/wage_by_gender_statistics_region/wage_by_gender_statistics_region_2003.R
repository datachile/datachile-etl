...
median_2003_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2003, FUN = median, na.rm = TRUE)
setnames(median_2003_region, colnames(median_2003_region), c("sexo","region","2003"))
...
mean_2003_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2003, FUN = mean, na.rm = TRUE)
setnames(mean_2003_region, colnames(mean_2003_region), c("sexo","region","2003"))
...
lb_median_2003_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2003, FUN = lb_median)
setnames(lb_median_2003_region, colnames(lb_median_2003_region), c("sexo","region","2003"))
...
ub_median_2003_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2003, FUN = ub_median)
setnames(ub_median_2003_region, colnames(ub_median_2003_region), c("sexo","region","2003"))
...
lb_mean_2003_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2003, FUN = lb_mean)
setnames(lb_mean_2003_region, colnames(lb_mean_2003_region), c("sexo","region","2003"))
...
ub_mean_2003_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2003, FUN = ub_mean)
setnames(ub_mean_2003_region, colnames(ub_mean_2003_region), c("sexo","region","2003"))
