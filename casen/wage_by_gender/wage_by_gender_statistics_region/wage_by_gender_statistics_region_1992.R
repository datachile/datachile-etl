...
median_1992_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1992, FUN = median, na.rm = TRUE)
setnames(median_1992_region, colnames(median_1992_region), c("sexo","region","1992"))
...
mean_1992_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1992, FUN = mean, na.rm = TRUE)
setnames(mean_1992_region, colnames(mean_1992_region), c("sexo","region","1992"))
...
lb_median_1992_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1992, FUN = lb_median)
setnames(lb_median_1992_region, colnames(lb_median_1992_region), c("sexo","region","1992"))
...
ub_median_1992_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1992, FUN = ub_median)
setnames(ub_median_1992_region, colnames(ub_median_1992_region), c("sexo","region","1992"))
...
lb_mean_1992_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1992, FUN = lb_mean)
setnames(lb_mean_1992_region, colnames(lb_mean_1992_region), c("sexo","region","1992"))
...
ub_mean_1992_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_1992, FUN = ub_mean)
setnames(ub_mean_1992_region, colnames(ub_mean_1992_region), c("sexo","region","1992"))
