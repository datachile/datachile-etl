...
median_2015_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2015, FUN = median, na.rm = TRUE)
setnames(median_2015_region, colnames(median_2015_region), c("sexo","region","2015"))
...
mean_2015_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2015, FUN = mean, na.rm = TRUE)
setnames(mean_2015_region, colnames(mean_2015_region), c("sexo","region","2015"))
...
lb_median_2015_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2015, FUN = lb_median)
setnames(lb_median_2015_region, colnames(lb_median_2015_region), c("sexo","region","2015"))
...
ub_median_2015_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2015, FUN = ub_median)
setnames(ub_median_2015_region, colnames(ub_median_2015_region), c("sexo","region","2015"))
...
lb_mean_2015_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2015, FUN = lb_mean)
setnames(lb_mean_2015_region, colnames(lb_mean_2015_region), c("sexo","region","2015"))
...
ub_mean_2015_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2015, FUN = ub_mean)
setnames(ub_mean_2015_region, colnames(ub_mean_2015_region), c("sexo","region","2015"))
