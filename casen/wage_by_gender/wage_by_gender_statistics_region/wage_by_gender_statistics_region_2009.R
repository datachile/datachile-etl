...
median_2009_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2009, FUN = median, na.rm = TRUE)
setnames(median_2009_region, colnames(median_2009_region), c("sexo","region","2009"))
...
mean_2009_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2009, FUN = mean, na.rm = TRUE)
setnames(mean_2009_region, colnames(mean_2009_region), c("sexo","region","2009"))
...
lb_median_2009_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2009, FUN = lb_median)
setnames(lb_median_2009_region, colnames(lb_median_2009_region), c("sexo","region","2009"))
...
ub_median_2009_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2009, FUN = ub_median)
setnames(ub_median_2009_region, colnames(ub_median_2009_region), c("sexo","region","2009"))
...
lb_mean_2009_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2009, FUN = lb_mean)
setnames(lb_mean_2009_region, colnames(lb_mean_2009_region), c("sexo","region","2009"))
...
ub_mean_2009_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2009, FUN = ub_mean)
setnames(ub_mean_2009_region, colnames(ub_mean_2009_region), c("sexo","region","2009"))
