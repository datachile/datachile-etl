...
median_2000_region <- aggregate(ingreso_ocup_principal  ~ region + sexo, data = wage_by_gender_2000, FUN = median, na.rm = TRUE)
...
mean_2000_region <- aggregate(ingreso_ocup_principal  ~ region + sexo, data = wage_by_gender_2000, FUN = "mean")
...
lb_median_2000_region <- aggregate(ingreso_ocup_principal  ~ region + sexo, data = wage_by_gender_2000, FUN = lb_median)
...
ub_median_2000_region <- aggregate(ingreso_ocup_principal  ~ region + sexo, data = wage_by_gender_2000, FUN = ub_median)
...
lb_mean_2000_region <- aggregate(ingreso_ocup_principal  ~ region + sexo, data = wage_by_gender_2000, FUN = lb_mean)
...
ub_mean_2000_region <- aggregate(ingreso_ocup_principal  ~ region + sexo, data = wage_by_gender_2000, FUN = ub_mean)
