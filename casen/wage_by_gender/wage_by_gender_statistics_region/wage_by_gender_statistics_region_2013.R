...
median_2013_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2013, FUN = median, na.rm = TRUE)
setnames(median_2013_region, colnames(median_2013_region), c("sexo","region","2013"))
...
mean_2013_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2013, FUN = mean, na.rm = TRUE)
setnames(mean_2013_region, colnames(mean_2013_region), c("sexo","region","2013"))
...
lb_median_2013_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2013, FUN = lb_median)
setnames(lb_median_2013_region, colnames(lb_median_2013_region), c("sexo","region","2013"))
...
ub_median_2013_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2013, FUN = ub_median)
setnames(ub_median_2013_region, colnames(ub_median_2013_region), c("sexo","region","2013"))
...
lb_mean_2013_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2013, FUN = lb_mean)
setnames(lb_mean_2013_region, colnames(lb_mean_2013_region), c("sexo","region","2013"))
...
ub_mean_2013_region <- aggregate(ingreso_ocup_principal ~ sexo + region, data = wage_by_gender_2013, FUN = ub_mean)
setnames(ub_mean_2013_region, colnames(ub_mean_2013_region), c("sexo","region","2013"))
