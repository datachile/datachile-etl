...
tidy_all_country <- join(tidy_mean_income_country, tidy_median_income_country, by = c("sexo","year"))
tidy_all_country <- join(tidy_all_country, tidy_lb_mean_income_country, by = c("sexo","year"))
tidy_all_country <- join(tidy_all_country, tidy_ub_mean_income_country, by = c("sexo","year"))
tidy_all_country <- join(tidy_all_country, tidy_lb_median_income_country, by = c("sexo","year"))
tidy_all_country <- join(tidy_all_country, tidy_ub_median_income_country, by = c("sexo","year"))
...
write.csv(median_income_country, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_median_income_country.csv")
write.csv(mean_income_country, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_mean_income_country.csv")
write.csv(tidy_all_country, file = "wage_by_gender/csv_final_files/wage_by_gender_tidy_all_country.csv")
