...
source("wage_by_gender/wage_by_gender_statistics_region/wage_by_gender_statistics_region.R")
...
write.csv(median_income_region, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_median_income_region.csv")
write.csv(mean_income_region, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_mean_income_region.csv")
write.csv(tidy_all_region, file = "wage_by_gender/csv_final_files/wage_by_gender_tidy_all_region.csv")
