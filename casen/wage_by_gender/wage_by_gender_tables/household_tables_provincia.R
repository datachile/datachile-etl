...
source("household_income/household_statistics_provincia/household_statistics_provincia.R")
...
lb_median_income_provincia <- lb_median_income_provincia[order(gini_income_provincia$provincia),]
...
ub_median_income_provincia <- ub_median_income_provincia[order(gini_income_provincia$provincia),]
...
lb_mean_income_provincia <- lb_mean_income_provincia[order(gini_income_provincia$provincia),]
...
ub_mean_income_provincia <- ub_mean_income_provincia[order(gini_income_provincia$provincia),]
...
lb_gini_income_provincia <- lb_gini_income_provincia[order(gini_income_provincia$provincia),]
...
ub_gini_income_provincia <- ub_gini_income_provincia[order(gini_income_provincia$provincia),]
...
write.csv(median_income_provincia, file = "household_income/csv_intermediate_files/median_income_provincia.csv")
write.csv(mean_income_provincia, file = "household_income/csv_intermediate_files/mean_income_provincia.csv")
write.csv(gini_income_provincia, file = "household_income/csv_intermediate_files/gini_income_provincia.csv")
write.csv(tidy_all_provincia, file = "household_income/csv_final_files/tidy_all_provincia.csv")
