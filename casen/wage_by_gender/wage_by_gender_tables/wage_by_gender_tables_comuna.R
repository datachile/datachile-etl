...
source("wage_by_gender/wage_by_gender_statistics_comuna/wage_by_gender_statistics_comuna.R")
...
tidy_all_comuna <- join(tidy_mean_income_comuna, tidy_median_income_comuna, by = c("sexo","comuna","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_lb_mean_income_comuna, by = c("sexo","comuna","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_ub_mean_income_comuna, by = c("sexo","comuna","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_lb_median_income_comuna, by = c("sexo","comuna","year"))
tidy_all_comuna <- join(tidy_all_comuna, tidy_ub_median_income_comuna, by = c("sexo","comuna","year"))
...
write.csv(median_income_comuna, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_median_income_comuna.csv")
write.csv(mean_income_comuna, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_mean_income_comuna.csv")
write.csv(tidy_all_comuna, file = "wage_by_gender/csv_final_files/wage_by_gender_tidy_all_comuna.csv")
