...
write.csv(median_income_region, file = "household_income/csv_intermediate_files/median_income_region.csv")
write.csv(mean_income_region, file = "household_income/csv_intermediate_files/mean_income_region.csv")
write.csv(gini_income_region, file = "household_income/csv_intermediate_files/gini_income_region.csv")
write.csv(tidy_all_region, file = "household_income/csv_final_files/tidy_all_region.csv")
