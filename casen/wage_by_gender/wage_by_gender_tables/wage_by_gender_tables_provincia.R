...
source("wage_by_gender/wage_by_gender_statistics_provincia/wage_by_gender_statistics_provincia.R")
...
tidy_all_provincia <- join(tidy_mean_income_provincia, tidy_median_income_provincia, by = c("sexo","provincia","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_lb_mean_income_provincia, by = c("sexo","provincia","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_ub_mean_income_provincia, by = c("sexo","provincia","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_lb_median_income_provincia, by = c("sexo","provincia","year"))
tidy_all_provincia <- join(tidy_all_provincia, tidy_ub_median_income_provincia, by = c("sexo","provincia","year"))
...
write.csv(median_income_provincia, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_median_income_provincia.csv")
write.csv(mean_income_provincia, file = "wage_by_gender/csv_intermediate_files/wage_by_gender_mean_income_provincia.csv")
write.csv(tidy_all_provincia, file = "wage_by_gender/csv_final_files/wage_by_gender_tidy_all_provincia.csv")
