...
wage_by_gender_2009 <- as.data.frame(cbind(as.character(casen_2009$comu), as.character(casen_2009$yopraj), as.character(casen_2009$sexo)))
setnames(wage_by_gender_2009, colnames(wage_by_gender_2009), c("comuna","ingreso_ocup_principal", "sexo"))
...
wage_by_gender_2009 <- wage_by_gender_2009[,c("comuna","provincia","region","ingreso_ocup_principal", "oficio_id", "sexo")]
