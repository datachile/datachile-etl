...
wage_by_gender_2000 <- as.data.frame(cbind(as.character(casen_2000$comu), as.character(casen_2000$yopraj), as.character(casen_2000$sexo)))
setnames(wage_by_gender_2000, colnames(wage_by_gender_2000), c("comuna","ingreso_ocup_principal", "sexo"))
...
wage_by_gender_2000 <- wage_by_gender_2000[,c("comuna","provincia","region","ingreso_ocup_principal", "oficio_id", "sexo")]
