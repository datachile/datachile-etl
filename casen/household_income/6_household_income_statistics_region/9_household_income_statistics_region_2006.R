...
# Median by region
weighted_median_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = matrixStats::weightedMedian(per_capita_income, w = exp_region, na.rm = TRUE))
setnames(weighted_median_2006_region, colnames(weighted_median_2006_region), c("region","2006"))
#weighted_median_2006_region <- insert_row(weighted_median_2006_region, c("Pa\u00eds", median(household_income_2006$per_capita_income, na.rm = TRUE)), nrow(weighted_median_2006_region)+1)
...
# Mean by region
weighted_mean_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = matrixStats::weightedMean(per_capita_income, w = exp_region, na.rm = TRUE))
...
# Gini by region
weighted_gini_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = SciencesPo::Gini(per_capita_income, weights = exp_region, na.rm = TRUE))
...
lb_weighted_median_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = lb_weighted_median_plyr(per_capita_income, exp_region))
...
ub_weighted_median_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = ub_weighted_median_plyr(per_capita_income, exp_region))
...
lb_weighted_mean_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = lb_weighted_mean_plyr(per_capita_income, exp_region))
...
ub_weighted_mean_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = ub_weighted_mean_plyr(per_capita_income, exp_region))
...
lb_weighted_gini_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = lb_weighted_gini_plyr(per_capita_income, exp_region))
...
ub_weighted_gini_2006_region <- ddply(household_income_2006, .(region), summarise, FUN = ub_weighted_gini_plyr(per_capita_income, exp_region))
