if ((exists("tidy_all_comuna") & exists("tidy_all_provincia") & exists("tidy_all_region") & exists("tidy_all_country")) == TRUE) {
  ...
  tidy_all_region <- read.csv("household_income/10_csv_final_files/household_income_tidy_all_region.csv")
  tidy_all_country <- read.csv("household_income/10_csv_final_files/household_income_tidy_all_country.csv")
