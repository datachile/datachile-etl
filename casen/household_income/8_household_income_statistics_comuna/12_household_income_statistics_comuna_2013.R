...
# Median by comuna
weighted_median_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = matrixStats::weightedMedian(per_capita_income, w = exp_region, na.rm = TRUE))
setnames(weighted_median_2013_comuna, colnames(weighted_median_2013_comuna), c("comuna","2013"))
#weighted_median_2013_comuna <- insert_row(weighted_median_2013_comuna, c("Pa\u00eds", median(household_income_2013$per_capita_income, na.rm = TRUE)), nrow(weighted_median_2013_comuna)+1)
...
# Mean by comuna
weighted_mean_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = matrixStats::weightedMean(per_capita_income, w = exp_region, na.rm = TRUE))
...
# Gini by comuna
weighted_gini_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = SciencesPo::Gini(per_capita_income, weights = exp_region, na.rm = TRUE))
...
lb_weighted_median_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = lb_weighted_median_plyr(per_capita_income, exp_region))
...
ub_weighted_median_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = ub_weighted_median_plyr(per_capita_income, exp_region))
...
lb_weighted_mean_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = lb_weighted_mean_plyr(per_capita_income, exp_region))
...
ub_weighted_mean_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = ub_weighted_mean_plyr(per_capita_income, exp_region))
...
lb_weighted_gini_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = lb_weighted_gini_plyr(per_capita_income, exp_region))
...
ub_weighted_gini_2013_comuna <- ddply(household_income_2013, .(comuna), summarise, FUN = ub_weighted_gini_plyr(per_capita_income, exp_region))
