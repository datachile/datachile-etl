...
household_income_2006 <- as.data.frame(cbind(as.character(casen_2006$comu), as.character(casen_2006$ymonehaj/casen_2006$numper)))
setnames(household_income_2006, colnames(household_income_2006), c("comuna","ingreso_pc"))
...
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<e1>", "\u00e1", x))) # a with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<c1>", "\u00c1", x))) # A with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xe9", "\u00e9", x))) # e with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<e9>", "\u00e9", x))) # e with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xed", "\u00ed", x))) # i with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<ed>", "\u00ed", x))) # i with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xf3", "\u00f3", x))) # o with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<f3>", "\u00f3", x))) # o with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xfa", "\u00fa", x))) # u with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<fa>", "\u00fa", x))) # u with acute 
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xda", "\u00da", x))) # U with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<da>", "\u00da", x))) # U with acute
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xf1", "\u00f1", x))) # n with tilde
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<f1>", "\u00f1", x))) # n with tilde
...
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("\xd1", "\u00d1", x))) # N with tilde
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<d1>", "\u00d1", x))) # N with tilde
...
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("<b4>", "\u0027", x))) # apostrophe
...
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub(" Los ", " los ", x)))
...
# Fix comuna
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Ollague", "Ollag\u00fce", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Paihuano", "Paiguano", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("La Calera", "Calera", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Llay Llay", "Llaillay", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Los Angeles", "Los \u00c1ngeles", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Alto B\u00edo B\u00edo", "Alto B\u00edob\u00edo", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Trehuaco", "Treguaco", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Teodoro Schimdt", "Teodoro Schmidt", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Ais\u00e9n", "Ays\u00e9n", x)))
household_income_2006 <- as.data.frame(lapply(household_income_2006, function(x) gsub("Los Alamos", "Los \u00c1lamos", x)))

# Add provincia and region
household_income_2006 <- join(household_income_2006, regiones_casen_2015, by = "comuna")
household_income_2006 <- household_income_2006[,c("comuna","provincia","region","ingreso_pc", "exp_region", "exp_comuna")]
