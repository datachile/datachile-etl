...
source("household_income/household_income_statistics_region/household_income_statistics_region.R")
...
lb_gini_income_region <- lb_gini_income_region[order(lb_gini_income_region$region),]
...
ub_gini_income_region <- ub_gini_income_region[order(ub_gini_income_region$region),]
...
tidy_all_region$ci_gini_income <- paste0("[",tidy_all_region$lb_gini_income,", ",tidy_all_region$ub_gini_income,"]")
...
write.csv(median_income_region, file = "household_income/csv_intermediate_files/household_income_median_income_region.csv")
write.csv(mean_income_region, file = "household_income/csv_intermediate_files/household_income_mean_income_region.csv")
write.csv(gini_income_region, file = "household_income/csv_intermediate_files/household_income_gini_income_region.csv")
write.csv(tidy_all_region, file = "household_income/csv_final_files/household_income_tidy_all_region.csv")
