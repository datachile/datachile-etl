...
source("household_income/household_income_statistics_country/household_income_statistics_country.R")
...
write.csv(median_income_country, file = "household_income/csv_intermediate_files/household_income_median_income_country.csv")
write.csv(mean_income_country, file = "household_income/csv_intermediate_files/household_income_mean_income_country.csv")
write.csv(gini_income_country, file = "household_income/csv_intermediate_files/household_income_gini_income_country.csv")
write.csv(tidy_all_country, file = "household_income/csv_final_files/household_income_tidy_all_country.csv")
