...
source("household_income/household_income_statistics_comuna/household_income_statistics_comuna.R")
...
lb_median_income_comuna <- lb_median_income_comuna[order(lb_median_income_comuna$comuna),]
...
ub_median_income_comuna <- ub_median_income_comuna[order(ub_median_income_comuna$comuna),]
...
lb_mean_income_comuna <- lb_mean_income_comuna[order(lb_mean_income_comuna$comuna),]
...
ub_mean_income_comuna <- ub_mean_income_comuna[order(ub_mean_income_comuna$comuna),]
...
lb_gini_income_comuna <- lb_gini_income_comuna[order(lb_gini_income_comuna$comuna),]
...
ub_gini_income_comuna <- ub_gini_income_comuna[order(ub_gini_income_comuna$comuna),]
...
write.csv(median_income_comuna, file = "household_income/csv_intermediate_files/household_income_median_income_comuna.csv")
write.csv(mean_income_comuna, file = "household_income/csv_intermediate_files/household_income_mean_income_comuna.csv")
write.csv(gini_income_comuna, file = "household_income/csv_intermediate_files/household_income_gini_income_comuna.csv")
write.csv(tidy_all_comuna, file = "household_income/csv_final_files/household_income_tidy_all_comuna.csv")
