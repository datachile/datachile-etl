...
# Median by provincia
weighted_median_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = matrixStats::weightedMedian(per_capita_income, w = exp_region, na.rm = TRUE))
setnames(weighted_median_1992_provincia, colnames(weighted_median_1992_provincia), c("provincia","1992"))
#weighted_median_1992_provincia <- insert_row(weighted_median_1992_provincia, c("Pa\u00eds", median(household_income_1992$per_capita_income, na.rm = TRUE)), nrow(weighted_median_1992_provincia)+1)
...
# Mean by provincia
weighted_mean_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = matrixStats::weightedMean(per_capita_income, w = exp_region, na.rm = TRUE))
...
# Gini by provincia
weighted_gini_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = SciencesPo::Gini(per_capita_income, weights = exp_region, na.rm = TRUE))
...
lb_weighted_median_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = lb_weighted_median_plyr(per_capita_income, exp_region))
...
ub_weighted_median_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = ub_weighted_median_plyr(per_capita_income, exp_region))
...
lb_weighted_mean_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = lb_weighted_mean_plyr(per_capita_income, exp_region))
...
ub_weighted_mean_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = ub_weighted_mean_plyr(per_capita_income, exp_region))
...
lb_weighted_gini_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = lb_weighted_gini_plyr(per_capita_income, exp_region))
...
ub_weighted_gini_1992_provincia <- ddply(household_income_1992, .(provincia), summarise, FUN = ub_weighted_gini_plyr(per_capita_income, exp_region))
