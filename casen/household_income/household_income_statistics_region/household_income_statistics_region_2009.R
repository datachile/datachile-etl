...
median_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = median, na.rm = TRUE)
...
#median_2009_region <- insert_row(median_2009_region, c("Pa\u00eds", median(household_income_2009$ingreso_pc, na.rm = TRUE)), nrow(median_2009_region)+1)
...
mean_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = mean, na.rm = TRUE)
...
gini_2009_region$`2009` <- as.numeric(gini_2009_region$`2009`)
gini_2009_region$`2009` <- round(gini_2009_region$`2009`, 3)

# Lower Bound for Median Household Income by region
lb_median_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = lb_median)
...
ub_median_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = ub_median)
...
lb_mean_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = lb_mean)
...
ub_mean_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = ub_mean)
...
lb_gini_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = lb_gini)
lb_gini_2009_region$region <- as.character(lb_gini_2009_region$region)
setnames(lb_gini_2009_region, colnames(lb_gini_2009_region), c("region","2009"))
lb_gini_2009_region$`2009` <- as.numeric(lb_gini_2009_region$`2009`)
lb_gini_2009_region$`2009` <- round(lb_gini_2009_region$`2009`, 3)

# Upper Bound for Gini Household Income by region
ub_gini_2009_region <- aggregate(ingreso_pc ~ region, data = household_income_2009, FUN = ub_gini)
ub_gini_2009_region$region <- as.character(ub_gini_2009_region$region)
setnames(ub_gini_2009_region, colnames(ub_gini_2009_region), c("region","2009"))
ub_gini_2009_region$`2009` <- as.numeric(ub_gini_2009_region$`2009`)
ub_gini_2009_region$`2009` <- round(ub_gini_2009_region$`2009`, 3)
