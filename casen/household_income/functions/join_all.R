if ((exists("tidy_all_comuna") & exists("tidy_all_provincia") & exists("tidy_all_region") & exists("tidy_all_country")) == TRUE) {
  ...
  write.csv(tidy_all, file = "household_income/csv_final_files/household_income_tidy_all.csv")
} else {
  tidy_all_comuna <- read.csv("household_income/csv_final_files/household_income_tidy_all_comuna.csv")
  tidy_all_provincia <- read.csv("household_income/csv_final_files/household_income_tidy_all_provincia.csv")
  tidy_all_region <- read.csv("household_income/csv_final_files/household_income_tidy_all_region.csv")
  tidy_all_country <- read.csv("household_income/csv_final_files/household_income_tidy_all_country.csv")
