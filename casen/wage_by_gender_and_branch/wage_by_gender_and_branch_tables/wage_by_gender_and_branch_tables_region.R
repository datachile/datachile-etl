...
source("wage_by_gender_and_branch/wage_by_gender_and_branch_statistics_region/wage_by_gender_and_branch_statistics_region.R")

###############
# join median #
###############

median_income_region <- as.data.frame(unique(c(as.character(median_2011_region$sexo), as.character(median_2015_region$sexo))))
...
mean_income_region <- as.data.frame(unique(c(as.character(mean_2011_region$sexo), as.character(mean_2015_region$sexo))))
...
lb_median_income_region <- as.data.frame(unique(c(as.character(lb_median_2011_region$sexo), as.character(lb_median_2015_region$sexo))))
...
ub_median_income_region <- as.data.frame(unique(c(as.character(ub_median_2011_region$sexo), as.character(ub_median_2015_region$sexo))))
...
lb_mean_income_region <- as.data.frame(unique(c(as.character(lb_mean_2011_region$sexo), as.character(lb_mean_2015_region$sexo))))
...
ub_mean_income_region <- as.data.frame(unique(c(as.character(ub_mean_2011_region$sexo), as.character(ub_mean_2015_region$sexo))))
...
tidy_median_income_region <- median_income_region %>% gather(year, median_income, `2011`:`2015`)
tidy_lb_median_income_region <- lb_median_income_region %>% gather(year, lb_median_income, `2011`:`2015`)
tidy_ub_median_income_region <- ub_median_income_region %>% gather(year, ub_median_income, `2011`:`2015`)

#############
# tidy mean #
#############

tidy_mean_income_region <- mean_income_region %>% gather(year, mean_income, `2011`:`2015`)
tidy_lb_mean_income_region <- lb_mean_income_region %>% gather(year, lb_mean_income, `2011`:`2015`)
tidy_ub_mean_income_region <- ub_mean_income_region %>% gather(year, ub_mean_income, `2011`:`2015`)

############
# join all #
############

tidy_all_region <- join(tidy_mean_income_region, tidy_median_income_region, by = c("sexo","rama","region","year"))
tidy_all_region <- join(tidy_all_region, tidy_lb_mean_income_region, by = c("sexo","rama","region","year"))
tidy_all_region <- join(tidy_all_region, tidy_ub_mean_income_region, by = c("sexo","rama","region","year"))
tidy_all_region <- join(tidy_all_region, tidy_lb_median_income_region, by = c("sexo","rama","region","year"))
tidy_all_region <- join(tidy_all_region, tidy_ub_median_income_region, by = c("sexo","rama","region","year"))
...
write.csv(median_income_region, file = "wage_by_gender_and_branch/csv_intermediate_files/wage_by_gender_and_branch_median_income_region.csv")
write.csv(mean_income_region, file = "wage_by_gender_and_branch/csv_intermediate_files/wage_by_gender_and_branch_mean_income_region.csv")
write.csv(tidy_all_region, file = "wage_by_gender_and_branch/csv_final_files/wage_by_gender_and_branch_tidy_all_region.csv")
...
rm(median_2011_region, median_2013_region, median_2015_region)

rm(mean_2011_region, mean_2013_region, mean_2015_region)

rm(lb_median_2011_region, lb_median_2013_region, lb_median_2015_region)

rm(ub_median_2011_region, ub_median_2013_region, ub_median_2015_region)

rm(lb_mean_2011_region, lb_mean_2013_region, lb_mean_2015_region)

rm(ub_mean_2011_region, ub_mean_2013_region, ub_mean_2015_region)
