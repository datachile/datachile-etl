...
source("wage_by_gender_and_branch/wage_by_gender_and_branch_statistics_country/wage_by_gender_and_branch_statistics_country.R")

###############
# join median #
###############

median_income_country <- as.data.frame(unique(c(as.character(median_2011_country$sexo), as.character(median_2015_country$sexo))))
...
mean_income_country <- as.data.frame(unique(c(as.character(mean_2011_country$sexo), as.character(mean_2015_country$sexo))))
...
lb_median_income_country <- as.data.frame(unique(c(as.character(lb_median_2011_country$sexo), as.character(lb_median_2015_country$sexo))))
...
ub_median_income_country <- as.data.frame(unique(c(as.character(ub_median_2011_country$sexo), as.character(ub_median_2015_country$sexo))))
...
lb_mean_income_country <- as.data.frame(unique(c(as.character(lb_mean_2011_country$sexo), as.character(lb_mean_2015_country$sexo))))
...
ub_mean_income_country <- as.data.frame(unique(c(as.character(ub_mean_2011_country$sexo), as.character(ub_mean_2015_country$sexo))))
...
tidy_median_income_country <- median_income_country %>% gather(year, median_income, `2011`:`2015`)
tidy_lb_median_income_country <- lb_median_income_country %>% gather(year, lb_median_income, `2011`:`2015`)
tidy_ub_median_income_country <- ub_median_income_country %>% gather(year, ub_median_income, `2011`:`2015`)

#############
# tidy mean #
#############

tidy_mean_income_country <- mean_income_country %>% gather(year, mean_income, `2011`:`2015`)
tidy_lb_mean_income_country <- lb_mean_income_country %>% gather(year, lb_mean_income, `2011`:`2015`)
tidy_ub_mean_income_country <- ub_mean_income_country %>% gather(year, ub_mean_income, `2011`:`2015`)

############
# join all #
############

tidy_all_country <- join(tidy_mean_income_country, tidy_median_income_country, by = c("sexo","rama","year"))
tidy_all_country <- join(tidy_all_country, tidy_lb_mean_income_country, by = c("sexo","rama","year"))
tidy_all_country <- join(tidy_all_country, tidy_ub_mean_income_country, by = c("sexo","rama","year"))
tidy_all_country <- join(tidy_all_country, tidy_lb_median_income_country, by = c("sexo","rama","year"))
tidy_all_country <- join(tidy_all_country, tidy_ub_median_income_country, by = c("sexo","rama","year"))
...
write.csv(median_income_country, file = "wage_by_gender_and_branch/csv_intermediate_files/wage_by_gender_and_branch_median_income_country.csv")
write.csv(mean_income_country, file = "wage_by_gender_and_branch/csv_intermediate_files/wage_by_gender_and_branch_mean_income_country.csv")
write.csv(tidy_all_country, file = "wage_by_gender_and_branch/csv_final_files/wage_by_gender_and_branch_tidy_all_country.csv")
...
rm(median_2011_country, median_2013_country, median_2015_country)

rm(mean_2011_country, mean_2013_country, mean_2015_country)

rm(lb_median_2011_country, lb_median_2013_country, lb_median_2015_country)

rm(ub_median_2011_country, ub_median_2013_country, ub_median_2015_country)

rm(lb_mean_2011_country, lb_mean_2013_country, lb_mean_2015_country)

rm(ub_mean_2011_country, ub_mean_2013_country, ub_mean_2015_country)
